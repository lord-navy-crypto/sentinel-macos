...
(() => {
  ...
  const dictionaries = {
    en: {
      ...
      'nav.easy':'Easy','nav.scan':'Scan','nav.security':'Security','nav.investigate':'Investigate','nav.system':'System','nav.processes':'Processes','nav.network':'Network','nav.startup':'Startup','nav.storage':'Storage','nav.advanced':'Advanced','nav.recover':'Recover','nav.terminal':'Terminal','nav.alpha':'Alpha',
    ...
    'zh-CN': {
      ...
      'nav.easy':'简易','nav.scan':'扫描','nav.security':'安全','nav.investigate':'调查','nav.system':'系统','nav.processes':'进程','nav.network':'网络','nav.startup':'启动项','nav.storage':'存储','nav.advanced':'高级','nav.recover':'恢复','nav.terminal':'终端','nav.alpha':'Alpha',
