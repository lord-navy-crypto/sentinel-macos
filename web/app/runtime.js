...
(() => {
  ...
  function loadResourceObservatory(){
  ...
  function loadTaskCenter(){
    ...
    const script=document.createElement('script');
    script.src='/app/task-center.js';
    script.dataset.sentinelTaskCenter='1';
    script.async=true;
    script.addEventListener('error',()=>console.warn('Sentinel Task Center could not be loaded.'));
    document.body.appendChild(script);
  }
