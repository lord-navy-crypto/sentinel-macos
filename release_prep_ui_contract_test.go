...
func TestReleasePrepUIBridgesExposeBoundedExportsAndGrouping(t *testing.T){
 checks:=map[string][]string{
  "web/intelligence-release-prep-v23.js":{"/api/intelligence/timeline/grouped","/api/incidents/export","Show Grouped Timeline","Export Incident JSON"},
  "web/investigation-export-v23.js":{"/api/security/investigation/export","Export Investigation Bundle","X-Sentinel-Token"},
  "web/control-plane-aging-v23.js":{"/api/storage/aging","oldest_large_files","Limitation:"},
 }
...
func TestReleasePrepBridgesAreLoaded(t *testing.T){
 pairs:=map[string]string{"web/intelligence-center.html":"/intelligence-release-prep-v23.js","web/investigation.html":"/investigation-export-v23.js","web/control-plane.html":"/control-plane-aging-v23.js"}
